...
$hidden['id_gl'] = $id_gl;
if (!empty($id_gl)) {
    $avalSet = sql::get('global_aval', '*', ['id_gl' => $id_gl, '>' => 'n_gl'], 'fetch');
}
if (!empty(@$id_agrup)) {
    ...
    <div class="noprint">
        ...
        <div class="noprint">
            ...
            <div class="row">
                <div class="col-md-6">
                    <?php
                    $where = ['ativo' => 1, '>' => 'n_agrup', 'tipo'=>'tri'];
                ...
                <div class="row">
                    ...
                    if (!empty($id_gl)) {
                        ...
                        <form method="POST">
                            <div class="col-md-5">
                                <?php
                                $turmas = turma::option($id_inst, $periodoLetivo, 'fk_id_inst', $avalSet['ciclos']);
        ...
        if (!empty($_POST['acessarGrafico'])) {
            ...
            $abas[1] = ['nome' => "Gráficos - % de Domínio de Habilidade", 'ativo' => 1, 'hidden' => $hidden, 'link' => "",];
            $abas[2] = ['nome' => "Tabela - % de Domínio de Habilidade (Individual/Sala)", 'ativo' => $aba1, 'hidden' => $hidden, 'link' => "",];
