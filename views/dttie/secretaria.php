...
$hiddenKey = DB::hiddenKey('dttie_suporte_trab', 'replace');
?>
<div class="fieldBody">
    ...
    <form action="" method="POST" >
        <div class="panel panel-default" >
            ...
            <div class="panel panel-body">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <?php formulario::input('1[local_sup]', 'Depto:', NULL, NULL, '  "') ?>
                    </div>
                    <div class="col-md-9">
                        <?php formulario::input('1[email]', 'E-mail do Local de Trabalho:', NULL, NULL, '  ') ?>
                    </div>
                    <div class="col-md-3">
        ...
        <div class="panel panel-default" >
            ...
            <div class="panel panel-body">
                <div class="col-md-3">
                    <?php
                    formulario::selectDB('dttie_list_sup_esc', '1[tipo_sup]', 'Suporte em:', @$campos['tipo_sup'], !empty($id) ? 'disabled' : '');
                    ?> 
                ...
                <div class="col-md-12">
                    <textarea <?php echo !empty($id) && @$campos['status_sup']!='Aberto' ? 'disabled  style="background-color: #dbc59e"' : '' ?> name="1[descr_sup]" style="width: 100%; height: 60px" placeholder="Descrição"><?php echo @$campos['descr_sup'] ?></textarea>
                </div>
                <?php
                if(!empty($id)){
                    ?>
