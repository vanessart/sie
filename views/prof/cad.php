...
<div class="fieldBody">
    ...
    <div>
        ...
        <form method="POST">
            <div class="fieldWhite"  id="fm" style="display:  <?php echo!empty($edit) ? "" : 'none' ?>; width: 95%">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <?php echo form::selectDB('ge_prof_sit_classe', 'fk_id_psc', 'Tipo Contrato', @$_POST['fk_id_psc']) ?>
                    </div>   
                </div>
                <br />
                <!--
        ...
        <div class="row">
            <div class="col-md-12">
                <?php
                $sql = "select distinct nao_hac, p.n_pessoa, p.emailgoogle as email, pe.rm, pe.id_pe, pe.disciplinas, hac_periodo, hac_dia,fk_id_psc from ge_prof_esc pe "
