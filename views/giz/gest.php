    ...
    if ($prof['gestor'] == 2) {
        ...
        <div style="text-align: center">
            <table style="margin: 0 auto">
                <tr>
                    <td>
                        <form target="_blank" action="<?php echo HOME_URI ?>/views/giz/img/norma.pdf" method="POST">
                            <input class="btn btn-success" type="submit" value="Formatação do Projeto Impresso " />
                        </form>  
                    </td>
                    <td>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                     ...
                     <td>
                        <form target="_blank" action="<?php echo HOME_URI ?>/views/giz/img/gestao.pdf" method="POST">
                            <input class="btn btn-success" type="submit" value="Relatório de Acompanhamento da Equipe de Gestão " />
                        </form>  
                    </td>
                    <td>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                     ...
                     <td>
                        <form target="_blank" action="<?php echo HOME_URI ?>/giz/prot" method="POST">
                            <input type="hidden" name="id_prof" value="<?php echo $prof['id_prof'] ?>" />
                            <input class="btn btn-success" type="submit" value="Protocolo" />
                        </form>  
                    </td>
                    <td>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <td>
                        <form target="_blank" action="<?php echo HOME_URI ?>/giz/aceite" method="POST">
                            <input type="hidden" name="id_prof" value="<?php echo $prof['id_prof'] ?>" />
                            <input class="btn btn-success" type="submit" value="Escopo do Projeto" />
                        </form>   
                    </td>
                </tr>
            </table>
