...
if (!empty($id_li)) {
    $esc = sql::get(['ge_escolas', 'instancia'], 'n_inst, longitude, latitude ', ['fk_id_inst' => $id_inst], 'fetch');
    ...
    if (!empty($id_li)) {
        ...
        <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDgyrNYpi6MldsIok86VBzqoGCFKfyQJas&libraries=visualization&callback=initMap"></script>
