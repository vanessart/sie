...
if (($model->_setup['aberto'] == 1) || user::session('id_nivel') == 10) {
    ...
    if (!empty($id_inst)) {
        ...
        <div class="fieldWhite">
            ...
            <div class="row">
                <div class="col-md-6">
                    <?php echo form::input('n_pessoa', 'Nome do Aluno:', @$_POST['n_pessoa'], ' id="busca" onkeypress="complete()" ') ?>
                </div>
                <div class="col-md-4">
                    <?php echo form::input('id_pessoa', 'RSE:', $id_pessoa, " id=\"rse\" required onkeypress='return SomenteNumero(event)' ") ?>
                </div>
                <div class="col-md-2">
        ...
        tool::modalInicio('width: 98%', 1);
        include ABSPATH . '/views/transp/_cadadaptado/form.php';
        tool::modalFim();
    }
}
...
<script>
    ...
    function carregar(rse) {
        if (rse != false) {
            ...
            $.post('<?php echo HOME_URI ?>/transp/cadadaptado', dados, function (retorna) {
