...
<div class="body">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            if (!empty($id_inst)) {
                ...
                if (!empty($transLinha)) {
                    echo form::select('id_li', $transLinha, 'Linha', $id_li, 1);
                } else {
                    ?>
    ...
    if ($id_li) {
        ?>
    <div>
        <form target="_blank" action="<?php echo HOME_URI ?>/transp/pdfcrachatransp" id="cart" method="POST">       
                    <?php
                    $turma = sql::get(['pessoa', 'gt_aluno'], '*', 'WHERE fk_id_li =' . $id_li . " AND fk_id_sa = 1 ORDER BY n_pessoa");
