...
<div class="fieldBody">
    ...
    <div class="row">
        <div class="col-sm-6">
            <?php echo form::select('destino', $destinoList, 'Destino', $destino, 1, ['statusMostrar' => $statusMostrar, 'id_inst' => $id_inst, 'id_li' => $id_li]) ?>
        </div>
        <div class="col-sm-6">
            <?php
            if ($destino) {
                echo form::select('id_inst', escolas::idInst(), 'Escola', $id_inst, 1, ['destino' => $destino, 'statusMostrar' => $statusMostrar, 'id_li' => $id_li]);
            }
            ?>
        </div>
        <br /><br />
        <div class="row">
            <div class="col-sm-5">
                ...
                if ($destino) {
                    echo form::select('statusMostrar', ['0, 1' => 'Deferidos e aguardando deferimento', '0, 1, 2, 6' => 'Todos os não alocados','T' => 'Todos'], 'Status', $statusMostrar, 1, ['destino' => $destino, 'id_inst' => $id_inst, 'id_li' => $id_li]);
                }
                ?>
                <br /><br />
                <?php
                if ($destino) {
                    ...
                    <form id="alunos" method="POST">
                        ...
                        <?php
                        echo form::hidden(['id_inst' => $id_inst, 'id_li' => $id_li, 'destino' => $destino]);
                        echo DB::hiddenKey('cadAlunoAdaptado');
                        ?>
                    </form>
                    <?php
                }
            ...
            <div class="col-sm-6">
                ...
                if ($destino) {
                    ...
                    $transLinha = transporte::nomeLinha(NULL, 1);

                    echo form::select('id_li', $transLinha, 'Linha', $id_li, 1, ['id_inst' => $id_inst, 'destino' => $destino, 'statusMostrar' => $statusMostrar]);
                }
                if (!empty($id_li)) {
                    $alunos = transporte::LinhaAlunosAdaptado($id_li);
                    ...
                    <form id="alunosTransp" method="POST" >
                        ...
                        <?php
                        echo form::hidden(['id_inst' => $id_inst, 'id_li' => $id_li, 'destino' => $destino]);
                        echo DB::hiddenKey('exclAlunoAdaptado');
                        ?>
                    </form>
                    <?php
                }
