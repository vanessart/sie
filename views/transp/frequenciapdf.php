...
if ($rel == 1) {
    ...
    $dados = transporte::alunoFrequencia($mes, $idlinha);
} else {
    if ($_POST['relatorio'] == 'Gerente') {
        $dados = transporte::alunoFrequencia($mes);
    }
}
        ...
        <table class="table tabs-stacked table-bordered">;
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="topo" style="width: <?php echo $larg . '%' ?>; text-align: left; fonte-size:7px; background-color: <?php echo $cor ?>">
                            <?php echo tool::abrevia($list['n_pessoa']) ?>        
                        </td>                      
                        ...
                        foreach ($list['frequencia'] as $kk => $vv) {
                            if ($vv == 'F') {
                                ?>
                                <td class="topo" style="width: 2.5%; background-color: #000000; color:#ffffff;">
                                    <?php
                                    echo $vv;
                                    ?>
                                </td>
                                ...
                                ?>
                                <td class="topo" style="width: 2.5%; background-color: <?php echo $cor ?>">
                                    <?php echo $vv ?>
                                </td>
                                <?php
                            }
                        ...
                        <td class="topo" style="width: 5%; background-color: <?php echo $cor ?>">
                            <?php echo @$list['ContaFalta'] ?>
                        </td>    
                        <td class="topo" style="width: 5%; background-color: <?php echo $cor ?>">
                            <?php echo @$list['ContaFrenquencia'] ?>
                        </td>
                </tbody>
                <?php
            }
            ...
            <tfoot>
                <tr>
                    ...
                    ?>  
                    <td class="topo" style="background-color: #000000; color: #ffffff">
                        <?php echo @$dados['linha'][$w]['ContaFalta'] ?>                  
                    </td>
                    <td class="topo" style="background-color: #000000; color: #ffffff">
                        <?php echo @$dados['linha'][$w]['ContaFrenquencia'] ?>                  
                    </td>
                </tr>
                <tr>
