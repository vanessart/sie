<br /><br />
<form id="inscri" method="POST">
    <div class="fieldWhite">
        <div class="row">
            <div class="col-md-8">
                <?php formulario::input('1[n_insc]', 'Nome', NULL, strtoupper(@$dados['n_insc']), 'required') ?>
            </div>
            <div class="col-md-4">
                <?php formulario::select('1[sexo]', ['F' => 'Feminino', 'M' => 'Masculino'], 'Sexo', @$dados['sexo'], NULL, NULL, 'required') ?>
            </div>
        </div>
        <div class="row">
            <div class="col-md-4">
                <?php formulario::input('1[dt_nasc]', 'D. Nasc.', NULL, data::converteBr(@$dados['dt_nasc']), ' required ' . '  ' . formulario::dataConf()) ?>
            </div>
            <div class="col-md-4">
        ...
        <div class="row">
            <div class="col-md-4">
                <?php formulario::selectDB('dtpg_seletivas', '1[fk_id_sel]', 'Seletiva', @$dados['fk_id_sel'], ' required') ?>
            </div>
            <div class="col-md-4" style="display: none">
                <?php formulario::input('1[classifica]', 'Classificação', NULL, empty($_POST['class']) ? @$dados['classifica'] : $_POST['class']) ?>
            </div>
            <div class="col-md-4" style="display: none">
                <?php formulario::input('1[nota]', 'Pontos:', NULL, @$dados['nota']) ?>
            </div>
        </div>
        <br />
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <input id="t1" placeholder="Celular" <?php echo @$readonly ?> type="text" name="1[tel1]" value="<?php echo @$dados['tel1'] ?>"   size="20" />
            </div>
            <div class="col-md-3">
                <input id="t2" placeholder="Residencial" <?php echo @$readonly ?> type="text" name="1[tel2]" value="<?php echo @$dados['tel2'] ?>"   size="20" />
            </div>
            <div class="col-md-3">
                <input id="t3" placeholder="Outro" <?php echo @$readonly ?> type="text" name="1[tel3]" value="<?php echo @$dados['tel3'] ?>"   size="20" />
            </div>
        </div>
        <br />
        <div class="row">
            <div class="col-md-12">
                <?php formulario::input('1[email]', 'E-mail: ', NULL, @$dados['email'], @$readonly . ' id="em" ') ?>
            </div>
        </div>
    </div>
    <br /><br />
    ...
    <div class="fieldWhite">
        <div class="row">
            <div class="col-md-4">
                <?php formulario::input('1[cpf]', 'CPF', NULL, @$dados['cpf'], (!empty($dados) ? ' readonly="readonly" ' : '') . ' required') ?>
            </div>
            <div class="col-md-3">
                <?php formulario::input('1[rg]', 'RG', NULL, @$dados['rg']) ?>
            </div>
            <div class="col-md-2">
                <?php formulario::input('1[rg_oe]', 'O. Exp.', NULL, @$dados['rg_oe']) ?>
            </div>
            <div class="col-md-3">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <textarea placeholder="Observações" name="1[obs]" style="width: 100%; height: 170px"><?php echo @$dados['obs'] ?></textarea>
            </div>
        </div>  
    </div>
    <br /><br />
    ...
    <div class="row">
        ...
        <div class="col-md-12 text-center">
            ...
            ?>
            <input type="text" name="DBDebug" value="1" />
