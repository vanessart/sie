...
if (empty($cargoId)) {
    ...
    <div style="text-align: center; width: 200px; margin: 0 auto">
        <?php formulario::select('id_cargo', $car, 'Disciplina', @$_POST['id_cargo'], 1, ['id_cad' => @$id_cad, 'id_inscr' => @$_POST['id_inscr'], 'fk_id_sel' => @$_POST['fk_id_sel'], 'class' => @$_POST['class'], 'activeNav' => 2]); ?>
    </div>
    <br /><br />
    <?php
    if (!empty($_POST['id_cargo'])) {
        $dis = sql::get(['dtgp_cadampe_esc', 'instancia'], 'fk_id_inst, m, n, t', ['fk_id_cargo' => @$_POST['id_cargo']]);
        foreach ($dis as $v) {
        ...
        $sql = " select n_inst, id_inst, bairro, m, t, n from instancia i "
                ...
                . " left join dtpg_cadamde_esc_vaga cv on cv.fk_id_inst = i.id_inst and cv.fk_id_cargo = " . @$_POST['id_cargo'] . ' '
                . " order by n_inst";
