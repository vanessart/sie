<?php
$esco = escolas::idInst();
$sql = "select s.n_sel, c.n_insc, c.tel1, c.tel2, c.tel3, c.email, c.cidade, c.bairro, c.id_cad, c.fk_id_inscr, classifica, c.cargos_e "
        . "from dtgp_cadampe c "
...
$tea = $query->fetchAll();
$carg = sql::get('dtgp_cadampe_cargo');
foreach ($carg as $v){
    ...
    <table border=1 cellspacing=0 cellpadding=1 style="width: 100%">
        ...
        foreach ($tea as $v) {
            ...
            <tr>
                ...
                <td>
                    <?php
                    $sql = "select * from dtpg_class cl "
                            . "left join dtgp_cadampe_cargo cc on cc.id_cargo = cl.fk_id_cargo "
                ...
                <td>
                    <?php
                    $sql = "select fk_id_inst from dtgp_cadampe_esc "
