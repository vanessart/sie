<?php
    ...
    ?>
    <br />
    <div class="fieldBody" style="font-size: 16px; width: 100%; background-color: <?php echo @$cor ?>">
        <div class="row">
            <div class="col-md-12" style="text-align: center; font-size: 18px">
                Manutenção da Classe - <?php // echo !empty($cor)?'2018':'2017'  ?>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                ...
                if (!empty($periodoLetivo)) {
                    formulario::select('turma', $turmaOptions, 'Selecione Código da Classe:', @$id_turma, 1, ['periodoLetivo' => $periodoLetivo]);
                }
                ?>
            </div>
        </div>
        ...
        if (!empty($id_turma)) {
            ...
            -->
            <form action="<?php echo HOME_URI ?>/gt/aluno" id="pessoa" method="POST">
