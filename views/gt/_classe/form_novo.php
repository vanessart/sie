<?php
$prof = funcionarios::professores(tool::id_inst(), 'instr', 1);
...
<form method="POST">
    <div class="row">
        ...
        <div class="col-lg-3">
            <?php formulario::select('1[periodo]', ['M' => 'Manhã', 'T' => 'Tarde', 'N' => 'Noite', 'G' => 'Geral'], "periodo", @$turma['periodo'], NULL, NULL, ' required ') ?>
        </div>
        <div class="col-lg-3">
            <?php @formulario::select('1[fk_id_pl]', gtMain::periodosCiclos(@$id_ciclo), "periodo Letivo", @$turma['fk_id_pl'], NULL, NULL, ' required ') ?>
        </div>
        <div class="col-lg-3">
            <?php
            for ($c = 'A'; $c < 'Z'; $c++) {
            ...
            formulario::select('1[letra]', $options_, 'Turma', @$turma['letra'], NULL, NULL, ' required ');
            ?>
        </div>
    </div>
    <br />
    <div class="row">
        ...
        -->
        <div class="col-lg-8">
            <?php echo formulario::select('1[rm_prof]', $prof, 'Professor Responsável', @$turma['rm_prof']) ?>
        </div>
    </div>
    <br />
    <div class="row">
