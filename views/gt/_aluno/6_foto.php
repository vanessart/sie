...
$_SESSION['tmp']['id_re'] = @$_POST['id_re'];
$_SESSION['tmp']['id_turma'] = @$_POST['id_turma'];
?> 
<br /><br /><br />
...
<div style="width: 260px; height: 312px; position: absolute; left: 52%;text-align: center;margin-top: 40px">
...
<script>
    ...
    document.getElementById("save").addEventListener("click", function () {
        $.post('<?php echo HOME_URI ?>/gt/fotossalvarre', {imagem: canvas.toDataURL()}, function (data) {
        }, 'json');
        alert("Imagem Salva");
        document.getElementById('ve').submit();
    });
</script>   
<form id="ve" method="POST">
