...
$classif = sql::get('cadam_class', '*', ['fk_id_inscr' => @$dados['fk_id_inscr'], 'fk_id_cargo' => @$_POST['id_cargo']], 'fetch')['class'];
$cargo = sql::get('cadam_cargo', 'n_cargo', ['id_cargo' => @$_POST['id_cargo']], 'fetch')['n_cargo'];
?>
<br /><br />
<style>
    td{
