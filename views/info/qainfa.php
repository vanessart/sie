...
<div class="fieldBody">
    <div style="text-align: center">
        NÚMERO DE CLASSES E ALUNOS - ENSINO INFANTIL - Pré 
    </div>
    <div  style="text-align: center">
        Atualizado em
        <?php
    ...
    if (empty($pdf)) {
        ?>
        <div>
            <form target="_blank" action="<?php echo HOME_URI ?>/info/qainfaPdf" style="text-align: right; width: 100%" method="POST">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    foreach ($ciclos as $ci) {
                        ?>
                        <td>
                            <?php echo round(@$result['totalAlunoCiclo'][$ci] / @$result['totalTurmas'][$ci], 1) ?>
                        </td>
                        <?php
                    }
                    ?>
        ...
        <table class="table table-bordered">
            <thead>
                <tr style="font-weight: bold">
                    ...
                    <td colspan="3" style="text-align: center;background-color:  #3c3c3c; color: white">
                        Manhã
                    </td>
                    <td colspan="3" style="text-align: center;background-color:  #3c3c3c; color: white">
                        Tarde
                ...
                <tr>
                    ...
                    for ($c1 = 1; $c1 <= 2; $c1++) {
                        ...
                        ?>
                        <td style="background-color:  #555555; color: white;border-right:  solid #000000 2px">
                            Total
                        </td>
                        <?php
                    }
            ...
            foreach ($result['escola'] as $k => $v) {
                if (!empty($result['turmas'][$k]['T']) || !empty($result['turmas'][$k]['M'])) {
                    $classes = 0;
                    $alunos = 0;
                    if ($conta % 6 == 0 && @$pdf <> 1) {
                        ?>
