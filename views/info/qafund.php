...
<div class="fieldBody">
    ...
    if (empty($pdf)) {
        ?>
        <div>
            <form target="_blank" action="<?php echo HOME_URI ?>/info/qafundPdf" style="text-align: right; width: 100%" method="POST">
            ...
            <tr>
                ...
                foreach (['M', 'T'] as $p) {
                    for ($c = 1; $c <= 9; $c++) {
                        ...
                        <td style="; <?php echo $c == 6 ? 'border-left: solid #000000 2px' : '' ?>">
                            <?php
                            echo round($talunos[$p][$c] / $tturma[$p][$c], 1);
                            ?>
                        </td>
                        <?php
                    }
