...
if (!empty($_POST['sel'])) {
    ...
    $ficha = $model->fichainscricao($idturmas);
    ...
    foreach ($ficha as $v) {
        ...
        <div>
            <table class="table tabs-stacked table-bordered">;
                ...
                <tr>
                    <td class="topo2" style="width: 7%">
                        CH
                    </td>
                    <td class="topo2" style="width: 9%">
                        RSE
                    </td><td class="topo2" style="width: 19%">
                        RA
                    </td>       
                    <td class="topo2" style="width: 12%">
                        Data Nasc.
                    </td>
                    <td class="topo2" style="width: 8%">
                        9º Ano
                    </td>
                ...
                <tr>
                    <td class="topo2" style="height: 20px">
                        <?php echo $v['chamada'] ?>
                    </td>
                    <td class="topo2" style="height: 20px">
        ...
        <div>
            <table style="width: 100%">
                ...
                <tr>
                    <td colspan="3" class="topo" style= "width: 70%">
                        E-mail: <b><?php echo $v['emailgoogle'] ?></b>
                    </td>
                </tr>
                <tr>
                    <td colspan="3" class="topo" style= "width: 70%">
