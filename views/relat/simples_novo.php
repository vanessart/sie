        ...
        <table style="background-color: white" class="table table-striped table-bordered table-hover sortable" id="tabela">
                        ...
                        <th class="fieldrow5">
                            ...
                            if (substr($k, 0, 2) != '||') {
                                if (strripos($k, 'input') === false) {
                                    ...
                                    <span onclick="busca(this, '<?php echo $y ?>')" style="float: right;cursor: pointer" class="glyphicon glyphicon-search buscaGIS" aria-hidden="true"></span>
                                    <?php
                                } else {
                                    echo $k;
                                }
            ...
            <tbody>
                ...
                foreach ($form['array'] as $kk => $vv) {
                    ...
                    $bg = '';
                    if($vv['check_update'] == 'SIM') {
                        //$bg = ' style="background: #dbebd0;" '; 
                    }                     
                    ...
                    <tr <?php echo $bg; ?> >
                        ...
                        foreach ($form['fields'] as $k => $v) {
                            ...
                            $check_update = '';
                            if(isset($k['check_update'])){
                                $check_update = '<i class="glyphicon glyphicon-user">';
                            }

                            ?>
                            <td <?php echo $nowrap; ?> <?php echo substr($k, 0, 2) != '||' ? '' : 'style="width: 10px; padding: 3px"' ?> >
                                <?php
