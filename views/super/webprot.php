<div class="row fieldMain" style="width: 900px; margin: 0 auto">
    <div class="col-md-12">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tr>
                        ...
                        <td rowspan="6" style="width: 160px">
                            <?php
                            $code = HOME_URI . '/app/code/php/qr_img.php?d=https://portal.educ.net.br/ge/super/webprot?id=' . '002' . @$campos['rastro_sup'] . @$campos['id_sup'] . '&.PNG';
                            ?>
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            002<?php echo @$campos['rastro_sup'] . @$campos['id_sup'] ?>(Rastreie seu pedido no site: www.educ.net.br)
                        </td>
                    </tr>
                </table>
                <br /><br />
