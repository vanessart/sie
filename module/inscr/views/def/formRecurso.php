...
if ($id_ec) {
    ...
    <div class="body">
        ...
        <form target="_parent" action="<?= HOME_URI ?>/inscr/recurso" method="POST">
            <div>
                <div class="row">
                    <div class="col-8">
    ...
    $abas[1] = ['nome' => "Dados Pessoais" . $deferido, 'ativo' => 1, 'hidden' => ['id_ec' => $id_ec]];
    $abas[2] = ['nome' => "Certificados", 'ativo' => 1, 'hidden' => ['id_ec' => $id_ec]];
    $abas[3] = ['nome' => "Recurso", 'ativo' => 1, 'hidden' => ['id_ec' => $id_ec]];
