...
<div class="body">
    <div class="fieldTop">
        Anexos da Proposta de Pauta
    </div>
    <?php if ( !empty($model::isCoordenadoria()) ) { ?>
    <form action="<?= HOME_URI ?>/htpc/proporPauta" target="_parent" method="POST" enctype="multipart/form-data" name="formapdup" id="formapdup">
        <div class="row">
            <div class="col">
        ...
        <br />
        <?=
        formErp::hidden(['fk_id_pauta_proposta' => $fk_id_pauta_proposta])
        . formErp::hiddenToken('uploadDocPautaProposta');
        ?>
    </form>
    <br><br>
    <?php } ?>
