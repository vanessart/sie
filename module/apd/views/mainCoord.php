        ...
        <div class="col-lg-4">
            <div style="margin: auto; width: 600px; padding: 20px">
                <video width="320" height="240" controls>
                    <source src="<?= HOME_URI ?>//pub/vd/Tutorial_SIEB_AEE_Sistema_Cadastro_de_Alunos.mp4" type="video/mp4">
                </video>
            </div>
        </div>
        <div class="col-lg-4">
            <div style="margin: auto; width: 600px; padding: 20px">
                <video width="320" height="240" controls>
                    <source src="<?= HOME_URI ?>//pub/vd/Tutorial_SIEB_AEE_Sistema_Cadastro_de_Professores.mp4" type="video/mp4">
                </video>
            </div>
        </div>
