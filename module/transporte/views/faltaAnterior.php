...
if (($model->_setup['abrir_falta'] == 1) || user::session('id_nivel') == 10) {
    ...
    $dias = dataErp::diasUteis($mes, null, $ano);
    ...
    if (!empty($id_li)) {
        ...
        $alunos = transporteErp::LinhaAlunos($id_li, NULL, '0,2,6');
    ...
    <div class="body">
        <div class="fieldTop">
            Controle de Faltas - Mêses Anteriores
        </div>
        <br />
        <div class="row">
            <?php
        ...
        <div class="row">
            <div class="col-sm-5">
                <?php               
                    echo formErp::select('mes', $mes_sel, 'Mês', $mes, 1);               
                ?>
            </div>
        </div>
        <br />
