...
$m = dataErp::meses();
$dados = transporteErp::alunoFrequencia($_POST['mes']);
$st = $model->getStatusAluno();
            ...
            foreach ($lista as $d) {
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="topo" style="fonte-size: 7px; text-align:left; background-color: <?php echo $cor ?>">
                            <?php echo toolErp::abrevia($d['n_pessoa']) ?>      
                        </td>
                        <td class="topo" style="background-color: <?php echo $cor ?>">
                            <?php echo $d['n_tv'] ?>
                        </td> 
                        <td class="topo" style="background-color: <?php echo $cor ?>">
                            <?php echo dataErp::periodoDoDia($d['periodo'])?>
                        </td> 
                        <td class="topo" style="background-color: <?php echo $cor ?>">
                        ...
                        <td class="topo" style="background-color: <?php echo $cor ?>">
                            <?php
                            echo dataErp::converteBr($d['dt_inicio']);
