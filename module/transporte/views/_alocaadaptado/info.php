...
<br />
<form target="_parent" action="<?= HOME_URI ?>/transporte/alocaadaptado" method="POST">
    <div style="width: 95%; margin: 0 auto">
        <div class="row">
            <div class="col-sm-12">
                <?php echo formErp::input(null, 'Nome*', $dados['n_pessoa'], ' disabled ') ?>
            </div>
        </div>
        <br />
        <div class="row">
            ...
            <div class="col-sm-3">
                <?php echo formErp::input(null, 'Idade*', $dados['idade'], ' disabled ') ?>
            </div>
            <div class="col-sm-6">
                <?php echo formErp::input('1[tp_def]', 'Tipo de Dificiência', $dados['tp_def']) ?>
            </div>
        </div>
        <br />
        <div class="row">
            <div class="col-sm-9">
                <?php echo formErp::input('1[logradouro]', 'Endereço', $dados['logradouro']) ?>
            </div>
            <div class="col-sm-3">
                <?php echo formErp::input('1[num]', 'Número', $dados['num']) ?>
            </div>
        </div>
        <br />
        <div class="row">
            <div class="col-sm-4">
                <?php echo formErp::input('1[cep]', 'CEP', $dados['cep']) ?>
            </div>
            <div class="col-sm-8">
                <?php echo formErp::input('1[bairro]', 'Bairro', $dados['bairro']) ?>
            </div>
        </div>
        <br />
        <div class="row">
            <div class="col-sm-8">
                <?php echo formErp::input(NULL, 'Responsável*', $dados['responsavel'], ' disabled') ?>
            </div>
            <div class="col-sm-4">
                <?php echo formErp::input(NULL, 'Data Nasc.', $dados['dt_nasc'], ' disabled id="dt_nasc" ', null, 'date') ?>
            </div>
        </div>
        <br />
        <div class="row">
            <div class="col-sm-8">
                <?php echo formErp::input(NULL, 'CPF Resp.*', $dados['cpf_respons'], ' disabled id="cpf_respons" ') ?>
            </div>
            <div class="col-sm-4">
                <?php echo formErp::input('1[rg_respons]', 'RG Resp.', $dados['rg_respons'], ' id="rg_respons"') ?>
            </div>
        </div>
        <br />
        <div class="row">
            <div class="col-sm-6">
                <?php echo formErp::input('1[tel1]', 'Tel Res.', $dados['tel1'], ' id="tel1" ') ?>
            </div>
            <div class="col-sm-6">
                <?php echo formErp::input('1[tel2]', 'Celular.', $dados['tel2'], ' id="tel2" ') ?>
            </div>
        </div>
        <br />
        <div class="row">
            <div class="col-sm-12">
                <?php echo formErp::input(NULL, 'Escola.*', $escola, NULL, '  disabled ') ?>
            </div>
        </div>
        <br />
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <span id="spamStatus<?= $k ?>" >
                                    ...
                                    echo formErp::select('2[status][' . $time['destino'] . ']', $options, 'Status', $time['fk_id_sa']);
                                    ?>
                                </span>
                            </div>
                        </div>
