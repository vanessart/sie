    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            <div style="overflow: auto; height: 250px">
                ...
                <br />
                <?php
                $linha = transporteErp::nomeLinha(NULL, 1);
                echo formErp::select('id_li', $linha, 'Linha', @$id_li, 1, ['id_li' => @$id_li, 'id_inst' => $id_inst]);
                ?>            
            </div>
        </div>
        <div class="col-sm-3">
            <div class="fieldWhite text-center" style="padding: 20px">
                <form target="_blank" action="<?php echo HOME_URI ?>/transporte/listaalunoadappdf" id="lista" method="POST">              
