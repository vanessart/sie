...
$veiculos = sqlErp::get('transporte_veiculo', 'placa, id_tv, n_tv', ['>' => 'placa']);
...
<div class="row">
    ...
    <div class="col-sm-5">
        <?php
        echo formErp::select('id_tv', $veiculoOption, 'Veículo', $id_tv, 1)
        ?>        
    </div>
    <?php ?>
    <div class="col-sm-3">
        <?php echo formErp::select('mes', $a, 'Selecionar Mês', @$mes, 1, ['id_tv' => $id_tv]) ?>
    </div>
    <div class="col-sm-3">
        <br /><br /><br />
    </div>
