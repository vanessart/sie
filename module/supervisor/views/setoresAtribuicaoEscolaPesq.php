...
if ($result) {
    foreach ($result as $k => $v) {
        ...
        $result[$k]['ac2'] = formErp::submit('Associar', null, ['id_setor' => $v['id_setor']], HOME_URI . '/supervisor/setoresAtribuicaoEscolaModal', null, null, 'btn btn-secondary');
...
<div class="body">
    <div class="fieldTop">
        Gerenciar Setores e atribuição de escolas
    </div>
    <div class="row">
        <div class="col">
    ...
    <form method="POST">
        <div class="row">
            <div class="col-4">
                <?= formErp::input('pesquisa', 'Descrição setor', $pesquisa) ?>
            </div>
            <div class="col-4">
