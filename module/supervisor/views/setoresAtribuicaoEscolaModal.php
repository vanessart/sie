...
if (@$_REQUEST[1] && $_REQUEST[1]['fk_id_setor']) {
...
if(!empty($resultPorInstancia)) {
    foreach ($resultPorInstancia as $k => $v) {
        $resultPorInstancia[$k]['1'] = ' <button onclick="remove('.$v['id_setor_instancia'].')" class="btn btn-danger"> X </button>';
    ...
    <div class="content">
        <div class="row" >
            <div class="col-md-6">
                <div class="input-group">
                    <div class="input-group-prepend">
                        <div class="input-group-text">Descrição do setor</div>
                    </div>
                    <input type="text" name="n_setor" readonly value="<?= $result['n_setor']?>"
            ...
            <div class="col-md-6">
                <div class="input-group">
                    <div class="input-group-prepend">
                        <div class="input-group-text">Supervisor</div>
                    </div>
                    <input type="text" name="n_pessoa" readonly value="<?= $result['n_pessoa']?>"
                        class="form-control form-control-plaintext">
                </div>
            </div>
        </div>
