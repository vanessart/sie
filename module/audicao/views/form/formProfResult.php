...
<br />
<table style="width: 100%; border-collapse: collapse; font-size: 12px; " border=1 cellspacing=0 cellpadding=5 class="tDados">
    <tr>
        <td colspan="2">
...
<?php $model->getViewPDF($form,$id_pessoa,2,true); ?>
<div class="row">
