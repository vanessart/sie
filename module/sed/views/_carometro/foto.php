...
<div style="height: 80vh"> 
    ...
    <script language="JavaScript">
        ...
        function salvar_foto()
        {
            ...
            ajax.open("POST", "<?php echo HOME_URI ?>/sed/fotossalvar?name=<?php echo @$id_pessoa ?>");
                    ajax.send(formdata);
                }
            ...
            <table class="fieldBorder2">
                ...
                <tr>
                    <td colspan="2">
                        ...
                        if (!empty($id_turma)) {
                            ?>
                            <form action="<?php echo HOME_URI ?>/sed/carometro" method="POST">
...
<form action="<?php echo HOME_URI ?>/sed/carometro" id="img" method="POST">
