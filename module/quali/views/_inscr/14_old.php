...
if (!empty($cpf) && empty($_POST['SalvaFormInscr'])) {
    ...
    if (!tool::cpfValida($cpf)) {
        ...
        tool::alert('Para participar do Projeto Programa de Desenvolvimento Organizacional é necessário ter 18 anos ou mais');
        $cpf = null;
        ...
        <form id="formEnvio" method="POST">
            ...
            <div class="caixag">
                ...
                <div class="row">
                    ...
                    <div class="col-5">
                        <?= form::input('1[cep]', 'CEP&nbsp;<span style="color: red">*</span>', null, ' id="cep" size="10" maxlength="9" ') ?>
                    </div>
                </div>
                <br />
                <div class="row">
                    <div class="col-sm-12 col-md-9">
                        <?= form::input('1[logradouro]', 'Logradouro&nbsp;<span style="color: red">*</span>', null, ' required id="rua" ') ?>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-8">
                        <?= form::input('1[bairro]', 'Bairro&nbsp;<span style="color: red">*</span>', null, ' required id="bairro" ') ?>
                    </div>
                </div>
                <br />
                <div class="row">
