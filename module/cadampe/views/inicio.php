    ...
    <div class="row">
        <div class="col-lg-8">
            <div style="margin: auto; width: 600px; padding: 20px">
                <iframe  width="600" height="300" src="https://www.youtube.com/embed/7IJqjhLuIuY" title="YouTube video player" frameborder="0" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
        </div>
