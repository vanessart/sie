...
<div style="text-align: center; font-weight: bold; font-size: 22px">
    TERMO DE RESPONSABILIDADE PELA GUARDA E USO DE EQUIPAMENTO DE INFORMÁTICA
    <hr>
</div>
...
<?php
if (!empty($id_chs)) {
    $sql = "select * from lab_chrome c "
            . "join lab_chrome_modelo m on m.id_cm = c.fk_id_cm "
            . " where id_ch in (" . implode(',', $id_chs) . ")";
    ...
    <table style="width: 100%" border=1 cellspacing=0 cellpadding=2 bordercolor="666633"> 
        ...
        <tr>
            <td colspan="3">
                Total de Chromebooks: <?= count($array) ?>
            </td>
        </tr>
    </table>
    <?php
