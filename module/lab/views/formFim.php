...
$sit = sql::get('lab_chrome_emprestimo_sit', '*', 'where id_ces != 1 ');
$sitEquip = toolErp::idName($sit, 'id_ces', 'equipamento');
$sitCarr = toolErp::idName($sit, 'id_ces', 'carregador');
?>
<div class="body">

    <form method="POST" target="_parent" action="<?= HOME_URI ?>/lab/emprestRede">
        <div class="fieldTop">
        ...
        <div class="row">
            <div class="col">
                <?=  
        formErp::select(null, $sitEquip, 'Equipamento', 3, null, null, ' disabled ', null, 1)
        .formErp::hidden(['fk_id_ces_equip'=>1])
        ?>
            </div>
        </div>
        <br />
