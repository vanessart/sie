...
foreach ($alunos as $k => $v) {
    ...
    if (empty($qrCode)) {
        if ($resp == 1) {
            $dadosForm = formDB::getViewPDFformatado($form,$v['id_pessoa'],1,$id_pl);
            $assinaturaArray = formDB::getAssinatura(1,$v['id_pessoa'],$id_pl);
            ...
            $dadosForm = formDB::getViewPDF($form,$v['id_pessoa'],1,$id_pl);
            ?>
            <br><br>
            <div class="row">
                <div  class="col col-sm">
