    ...
    foreach ($alunos as $k => $v){
        foreach ($v as $y){
               $array[]=[
                ...
                'Sexo' => $y['sexo'],
                'Cartão SUS' => $y['sus'],
                'Palestra' => $y['orient_odonto'],
                'Avaliação Odontológica' => $y['aval_odonto'],
                'Necessita Tratamento Dentário' => $y['nec_tratamento'],
                'Tratamento Dentário realizado' => $y['real_tratamento'],
            ]; 
        }
    }
}
