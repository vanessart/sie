...
<div class="body">
    <div class="row">
        <div class="col-10" style="font-weight:bolder; font-size:12pt; background-color: #000000; color:#ffffff; text-align: center; padding: 5pt">
            Resumo - Escola
        </div>
        <div class="col-2">
            <form target="_blank" action="<?= HOME_URI ?>/passelivre/pdf/pdfresumo.php" method="POST">
