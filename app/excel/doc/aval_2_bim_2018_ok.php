...
$sql =    " select ga.perc, i.n_inst, ga.ciclos, gt.letra, ga.fk_id_disc, gr.* from global_respostas gr "
        ...
        . " where ga.fk_id_agrup in ('10','11','12') " // 2º Bimestre 2018
...
// Rename worksheet
$objPHPExcel->getActiveSheet()->setTitle('ejf_2018_2_bim');
...
header('Content-Disposition: attachment;filename="' . 'ejf_2018_2_bim' . '.xls"');
