...
$sql = "SELECT ap.rm, ap.fk_id_turma, ap.iddisc as fk_id_disc,"
        . " IFNULL(d.n_disc, 'Polivalente') AS Disciplina,"
        . " ap.fk_id_inst FROM ge_aloca_prof ap"
        . " left JOIN ge_disciplinas d on d.id_disc = ap.iddisc"
        . " JOIN ge_turmas t ON t.id_turma = ap.fk_id_turma"
        . " JOIN ge_periodo_letivo pl ON pl.id_pl = t.fk_id_pl WHERE pl.at_pl = 1";

@$nomearquivo = 'prof_classe';
