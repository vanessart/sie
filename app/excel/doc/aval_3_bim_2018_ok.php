...
$sql =    " select ga.perc, i.n_inst, ga.ciclos, gt.letra, ga.fk_id_disc, gr.* from global_respostas gr "
        ...
        . " where ga.fk_id_agrup in ('13','14','15') " // 3º Bimestre 2018
...
// Rename worksheet
$objPHPExcel->getActiveSheet()->setTitle('ejf_2018_3_bim');
...
header('Content-Disposition: attachment;filename="' . 'ejf_2018_3_bim' . '.xls"');
