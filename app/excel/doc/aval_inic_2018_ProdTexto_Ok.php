...
$sql = "select perc, i.n_inst, ga.ciclos, gt.letra, ga.fk_id_disc, gr.* from global_respostas gr "
        ...
        . "where `fk_id_agrup` = 2 " // 'fk_id_agrup' = 2 significa Avaliação Inicial 2018
        . "and fk_id_disc in (29) "
        . "and ciclos in (1,2,3,4,5,6,7,8,9) "
...
// Rename worksheet
$objPHPExcel->getActiveSheet()->setTitle('aval_inic_2018_PodText');
...
header('Content-Disposition: attachment;filename="' . 'aval_inic_2018' . '_' . date("Y_m_d") . '.xls"');
