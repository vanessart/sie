...
$sql =    " select perc, ciclos, fk_id_disc from global_aval "
        . " where fk_id_agrup in ('4','5') " // 1º Bimestre 2018      
...
$sql =    " select ga.perc, i.n_inst, ga.ciclos, gt.letra, ga.fk_id_disc, gr.* from global_respostas gr "
        ...
        . " where ga.fk_id_agrup in ('4','5') " // 1º Bimestre 2018
...
// Rename worksheet
$objPHPExcel->getActiveSheet()->setTitle('ejf_2018_1_bim');
...
header('Content-Disposition: attachment;filename="' . 'ejf_2018_1_bim' . '.xls"');
