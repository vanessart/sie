...
$sql = "select perc, ciclos, fk_id_disc from global_aval "
        . " where `fk_id_agrup` in (13,14,15)" // 3º Bimestre 2018
        . " and ciclos in (1,2,3,4,5,6,7,8,9) "
        . " and fk_id_disc in (6,9,12,13,14,29) ";
...
$disciplinas = [6 => 'Matemática', 9 => 'Português', 29 => 'Produção de Texto', 12 => 'Ciências Naturais', 14 => 'Geografia', 13 => 'História'];
$cont = 2;
...
// Rename worksheet
$objPHPExcel->getActiveSheet()->setTitle('2018_3_bim');
...
header('Content-Disposition: attachment;filename="' . '2018_3_bim' . '_' . date("Y_m_d") . '.xls"');
