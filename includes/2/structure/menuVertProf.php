...
if (!empty($msg)) {
    foreach ($msg as $v) {
        if ($v['novo'] == 1) {
            $iconMsg = HOME_URI.'/'. INCLUDE_FOLDER .'/images/msgRed.png';
        }else{
            $iconMsg = HOME_URI.'/'. INCLUDE_FOLDER .'/images/msgGreen.png'; 
        } 
        break; 
    }  
}else{
    ...
    <a href="<?= HOME_URI ?>/home/perfilVert">
        <li>
            ...
            <td style="text-align: center; font-weight: bold; color: #000000">
                <img src="<?= HOME_URI ?>/<?= INCLUDE_FOLDER ?>/images/brasao.png" style="height: 68px" alt="<?= NOME3 ?>"/>
            </td>
