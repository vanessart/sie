...
if (@$setPage != 'home') {
    if ($this->logged && @$setPage != 'access' && !empty($_SESSION['systemData'])) {
        ...
        if (file_exists(ABSPATH . '/'. INCLUDE_FOLDER .'/images/logosystem/' . @$_SESSION['systemData']['arquivo'] . '.png')) {
            $logo = HOME_URI . '/'. INCLUDE_FOLDER .'/images/logosystem/' . @$_SESSION['systemData']['arquivo'] . '.png';
