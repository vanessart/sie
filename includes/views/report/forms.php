...
?>
<script src="<?php echo HOME_URI; ?>/includes/js/sorttable.js"></script>
<?php
...
if (!empty($form['array']) && !empty($form['fields'])) {
    if (!empty($table)) {
        $form['fields']['||11'] = 'apagar';
    }
    $form['fields']['||22'] = 'acessar';
    $form['array'] = form::submitAcessarApagar($form['array'], $table, $hidden, $location, $target, $msg, NULL, $buttonName);
    ?>
    <div id="divConteudo">
